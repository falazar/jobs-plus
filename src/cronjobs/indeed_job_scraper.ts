...
export async function run() {
    ...
    await scrapeIndeedJobPage(url)

    // process.exit()
}

async function scrapeIndeedJobPage(jobUrl: string) {
    // tslint:disable-next-line:no-console
    console.log("Indeed scrape starting... job url=", jobUrl)
    ...
    // tslint:disable-next-line:no-console
    console.log("completed scraping job page");
}
